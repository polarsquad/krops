...
- Workload clusters hold no AWS credentials of any kind. The management
  cluster holds the CAPA and ACK credentials as SOPS-encrypted secrets; the
  ACK credential's permissions are listed in `docs/aws-iam.md`.

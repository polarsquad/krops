...
Design proposals and architecture discussions, under review or accepted. A
proposal is reviewed as a pull request; once accepted it is split into
sub-issues, and the resulting behavior is documented in the regular `docs/`
pages. Each proposal states its status at the top and links its
tracking issue.
